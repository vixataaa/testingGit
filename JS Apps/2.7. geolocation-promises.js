(function() {
    ...
    function createGeolocationImage(coordsObj) {
        var imgElement = document.createElement("img"),
            imgSrc = "http://maps.googleapis.com/maps/api/staticmap?center=" + coordsObj.lat + "," + coordsObj.long + "&zoom=13&size=500x500&" + 
                "&markers=color:red%7C" + coordsObj.lat + "," + coordsObj.long;             
            console.log("Lat: " + coordsObj.lat);
            console.log("Long: " + coordsObj.long);
